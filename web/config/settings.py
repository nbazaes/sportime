...
SECRET_KEY = 'django-insecure-m1ggyp0i8dfkdz27+355vi&zxbva#yva-ch+!h(sxfvn9zaf63'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'sportime'),
        'USER': os.getenv('DB_USER', 'sportime'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'sportime123'),
